...
- 覆盖内容：
  ...
  - 移动端折叠状态、标题栏、点击高亮、Toast 自动消失和检查器切换动画回归
...
| 步骤标题栏 | 通过。阶段计数收紧为 `PHASE 01/29`；中文标题使用正常字距并按剩余空间省略；说明按钮跟随标题，右侧仅保留清空和概览折叠按钮。折叠、展开及说明弹层均在当前 MuMu 实机复验。 |
...
- SHA-256：`CFCC87B1DBE7EE95A9E8649F9D80D68C3404C398C7176BCCDE20597DD784FA45`
...
- 最终界面截图：`.gstack/qa-reports/screenshots/ui-parity-mumu-icons-fold-main-final-20260724.png`
