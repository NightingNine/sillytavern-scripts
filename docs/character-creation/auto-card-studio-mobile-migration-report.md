...
| 步骤标题栏 | 通过。移除 `PHASE 01/29` 阶段计数；中文标题使用正常字距并获得完整剩余空间；说明、清空和概览折叠图形缩小，但 27px 点击区域保持不变。折叠、展开及说明弹层均在当前 MuMu 实机复验。 |
...
- `versionName`：`0.2.0`
- `versionCode`：`2000`
- 大小：498,774,529 bytes
- SHA-256：`556A9F7D98BFD8C3508CAFDC8DC7319FF835A65020400C1B672DFE8F3F62D3E5`
...
- 最终界面截图：`.gstack/qa-reports/screenshots/ui-regression-stage-overview-expanded-final-20260724.png`
- 展开动画录屏：`.gstack/qa-reports/screenshots/ui-regression-stage-overview-slide-final-20260724.mp4`
