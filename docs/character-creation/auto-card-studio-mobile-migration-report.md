...
| 步骤标题栏 | 通过。移除 `PHASE 01/29` 阶段计数；中文标题使用正常字距并获得完整剩余空间；必做、说明、清空和概览折叠统一为 23px 高度并沿同一顶部基线对齐。标题栏在概览收起和展开时均固定为 54px，不再发生高度跳变。 |
...
- SHA-256：`A5D08CE675CB2CFBF0BB3B757D150FA34541D74944418314B64984D2E23FE94C`
...
- 最终界面截图：`.gstack/qa-reports/screenshots/ui-regression-stage-header-expanded-final-v3-20260724.png`
