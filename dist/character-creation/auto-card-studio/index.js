// A.U.T.O 角色卡创作台 v0.4.2 · 酒馆助手脚本核心包（内置自动更新器）
...
const AUTO_CARD_STUDIO_VERSION = '0.4.2';
const UPDATE_CATALOG_URL = 'https://raw.githubusercontent.com/NightingNine/sillytavern-scripts/main/catalog.json';
...
async function getLatestPublishedVersion() {
    const requestUrl = `${UPDATE_CATALOG_URL}?auto-card-studio=${Date.now()}`;
    const response = await hostWindow.fetch(requestUrl, { cache: 'no-store' });
