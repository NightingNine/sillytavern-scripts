...
// GitHub 分支接口暂时不可用时，至少回退到最近一次正式版构建。
const FALLBACK_REVISION = 'a5fc7822e05cee7b7aae281bcd647059aa323a28';
...
async function resolveLatestRevision() {
    ...
    if (!/^[0-9a-f]{40}$/i.test(revision)) throw new Error('测试分支没有返回有效版本号');
    return revision;
}
